...
<body style="width:100vw;" >
  ...
  <div class="cotainer-fluid "   style="width:100vw">
    ...
    <form class="form-inline"  method="post" >
     ...
     <button type="submit" class="btn btn-primary mb-2"    style="POSITION:RELATIVE;left:44vw;" name="log"  >LOGIN</button>
	 
     <button type="submit" class="btn btn-primary mb-2"  style="POSITION:RELATIVE;left:45vw;" name="sign"  >SIGN UP</button>
  ...
  <div class="conainer-fluid"  style="BACKGROUND-COLOR:#e6e6e6; height:50vw;">
