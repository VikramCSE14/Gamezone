...
<body style="width:100vw;" >
  ...
  <div class="cotainer-fluid" style="BACKGROUND-COLOR:black;">
    <div class="row">  
        ...
        <div class="col" >
            <IMG  SRC="BALL2.JPG"   STYLE="HEIGHT:6vw;WIDTH:8vw;FLOAT:RIGHT;POSITION:RELATIVE;ANIMATION-NAME:IMG2; ANIMATION-DURATION:10S; animation-timing-function:LINEAR;ANIMATION-ITERATION-COUNT:INFINITE;ANIMATION-DIRECTION:ALTERNATE;"  ALT="IMAGE"> 
        </div>
    ...
    <div STYLE="BACKGROUND-COLOR:WHITE;TOP:20VW; MARGIN:0PX ;WIDTH:80VW;PADDING:0PX;VISIBILITY:HIDDEN;position:absolute;left:10vw; top:2vw;"  ID="FORM1" >
       ...
       <BR> 
        ...
        <INPUT TYPE="TEXT" class="form-control"  NAME="S1"  VALUE=0  STYLE="BACKGROUND-COLOR:#e6e6e6; FONT-SIZE:2vw; WIDTH:25vw;POSITION:RELATIVE;LEFT:38vw;TOP:-2VW;"  ID="SCORE1">
		 ...
		 <label class="form-check-label" for="msg1" STYLE="FONT-SIZE:1.5vw ;POSITION:RELATIVE;TOP:1VW;VISIBILITY:hidden;" ID="MSG1">"Sorry. You have lost the match by "+(score-S)+"runs. BETTER LUCK NEXT TIME.presO CONTIUE TO PROCEEDs CONTINE "</LABEL>
         <BR>
    ...
    <div STYLE="BACKGROUND-COLOR:WHITE;TOP:20VW; MARGIN:0PX ;WIDTH:80VW;PADDING:0PX;VISIBILITY:hidden;position:absolute;left:10vw; top:2vw;"  ID="FORM2" >
       ...
       <BR> 
        ...
        <INPUT TYPE="TEXT" class="form-control"  NAME="S2"  VALUE=0  STYLE="BACKGROUND-COLOR:#e6e6e6; FONT-SIZE:2vw; WIDTH:25vw;POSITION:RELATIVE;LEFT:38vw;TOP:-2VW;"  ID="SCORE2">
 		...
 		<label class="form-check-label" for="msg1" STYLE="FONT-SIZE:1.5vw ;POSITION:RELATIVE;TOP:1VW;visibility:hidden;" ID="MSG2">"Sorry. You have lost the match by "+(score-S)+"runs. BETTER LUCK NEXT TIME."</LABEL>
        <BR>        
     ...
     <BR>
     <BUTTON TYPE="SUBMIT" class="btn btn-primary mb-2 BUTTON"  STYLE="BACKGROUND-COLOR:#595959;POSITION:ABSOLUTE ;TOP:7vw ;LEFT:40vw ; VISIBILITY:HIDDEN;"   onClick="location.reload();"  ID="RESTART">START&nbsp; GAME</BUTTON>
                                              ...
                                              W=W+1;
                                                if(W==3)                      
                                                 {  
	                                                ...
	                                                document.getElementById("MSG2").style.visibility="visible";
                                                    document.getElementById("CONT2").style.visibility="visible"	;
													document.getElementById("MSG2").innerHTML="Congratulations! You have won the match by "+ (score-S) + " runss.";
                                           ...
                                           if(S>score) 
                                              {
                                               ...
                                               document.getElementById("MSG2").style.visibility="visible";
                                               document.getElementById("CONT2").style.visibility="visible";													
											   document.getElementById("MSG2").innerHTML="Sorry. You have lost the match by "+(3-W)+"wicketss. BETTER LUCK NEXT TIME."; 
